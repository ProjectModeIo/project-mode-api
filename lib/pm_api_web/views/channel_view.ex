...
defmodule PmApiWeb.ChannelView do
  ...
  def render("channeldetails.json", %{channel: channel}) do
    %{
      id: channel.id,
      name: channel.name,
      role: render_one(channel.role, PmApiWeb.RoleView, "role_connections.json"),
      skill: render_one(channel.skill, PmApiWeb.SkillView, "skill_connections.json"),
      interest: render_one(channel.interest, PmApiWeb.InterestView, "interest_connections.json")
    }
  end
